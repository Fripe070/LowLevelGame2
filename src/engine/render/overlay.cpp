...
ScreenOverlay::ScreenOverlay(): shader({
    Engine::loadShaderFile("resources/assets/shaders/overlay.vert", Engine::ShaderType::VERTEX).value(),
    Engine::loadShaderFile("resources/assets/shaders/overlay.frag", Engine::ShaderType::FRAGMENT).value()
}) {
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(ScreenSpaceQuadIndices), ScreenSpaceQuadIndices.data(),
                 GL_STATIC_DRAW);
